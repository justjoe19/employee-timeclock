...
class Employee:
    ...
    def is_clocked_in(self):
        c.execute("SELECT punch_type FROM punches WHERE employee_id = ? ORDER BY punch_time DESC LIMIT 1", (self.employee_id,))
        result = c.fetchone()
    ...
    def punch(self):
        ...
        c.execute("INSERT INTO punches VALUES (?, ?, ?)", (self.employee_id, current_time, punch_type))
        conn.commit()
